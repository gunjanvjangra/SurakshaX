...
const WhySurakshaX = () => {
  return (
    <section className="bg-white text-gray-900 py-16 px-6 text-center">
      <h2 className="text-3xl md:text-4xl font-bold text-green-900">Why Crisis Education Matters</h2>
      <p className="mt-4 text-lg max-w-3xl mx-auto">
        Disasters strike without warning. Knowledge is the first step to survival. SurakshaX transforms 
        crisis preparedness into an engaging and actionable experience.
      </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-10">
        ...
        <div className="p-6 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mt-2">Earthquakes, floods, crowd stampedes, heatwaves, and more.</p>
        </div>
        ...
        <div className="p-6 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mt-2">Learn through interactive challenges & quizzes.</p>
        </div>
        ...
        <div className="p-6 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 mt-2">Real stories, expert insights, and shared experiences.</p>
        </div>
      </div>
    </section>
  );
